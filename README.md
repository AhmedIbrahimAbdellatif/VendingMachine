...
In this exercise I built the brains of a vending machine.  It accepts money, makes change, maintains
inventory, and dispenses products.  All the things that you might expect a vending machine to accomplish.
...
When the item selected by the customer is out of stock, the machine displays CANNOT FIND PRODUCT and the money the customer has placed in the machine is returned.
